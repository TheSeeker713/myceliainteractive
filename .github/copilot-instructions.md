...
1. **MANDATORY READING**: Before generating ANY plan, writing ANY code, or executing ANY command, you MUST read `AGENTS.md` located in the **project source root** (`AGENTS.md`). Also read `TEAM_CONTRACT.md` at the project root — it defines how this repo coordinates with the `liminal-sin-gemini` backend repo. This is non-negotiable.
