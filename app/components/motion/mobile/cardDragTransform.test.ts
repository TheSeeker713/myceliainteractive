...
describe("cardDragTransform", () => {
  it("writes translate3d + rotate and clears cleanly", () => {
    ...
    applyCardDragTransform(el, -80, 400, false);
    expect(style.transition).toBe("none");
    expect(style.transform).toContain("translate3d(-80px, 0, 0)");
    expect(style.transform).toContain("rotate(");

    applyCardDragTransform(el, 0, 400, true);
    expect(style.transition).toContain("220ms");
    expect(style.transform).toContain("translate3d(0px, 0, 0)");
