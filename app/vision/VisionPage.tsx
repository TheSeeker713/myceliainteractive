...
export function VisionPage() {
  return (
    <div className="site-gutter pb-20">
      <SectionReveal className="studio-section pt-16 sm:pt-24 pb-12">
      ...
      <SectionReveal className="studio-section pb-12">
        <StudioCard className="p-6 sm:p-8 border-studio-accent/20 bg-studio-accent-light/30">
          ...
          <p className="text-studio-text-muted leading-relaxed">
            ...
            <strong className="text-studio-text">not</strong> part of the
            near-term MVP or 24-month roadmap. For current milestones, see the{" "}
      ...
      <SectionReveal className="studio-section pb-16">
        ...
        <p className="text-studio-text-muted max-w-3xl leading-relaxed mb-8">
          ...
          creative work. Entertainment remains the proving ground; the north
          star is human-centered, always-on agentic companionship in physical
          space.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          {HORIZON_PHASES.map((phase) => (
            <StudioCard key={phase.year} className="p-6">
